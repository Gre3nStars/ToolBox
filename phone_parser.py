"""
Author: Gre3nStars
Date: 2025-08-07 16:19:07
LastEditTime: 2025-08-07 16:26:55
Description: 
FilePath: ToolBox_internal/utils/phone_parser.py
...
class Phone(object):
    def __init__(self, dat_file=None):
        ...
        if dat_file is None:
            dat_file = os.path.join(os.path.dirname(__file__), "../resource/phone.2503.dat")
