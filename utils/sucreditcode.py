"""
Author: Gre3nStars
Date: 2025-08-07 15:42:07
LastEditTime: 2025-08-07 15:44:47
Description: 
FilePath: ToolBox_internal/utils/sucreditcode.py
...
class CreditIdentifier(object):
    ...
    def get_random_address():
        with open(Path(__file__).parent / "../resource/address.json",encoding='utf-8',errors='ignore') as reader:
